        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form action="{{ route('kriteria.store') }}" method="POST">
                ...
                <div class="mb-10 px-2">
                    <h2 class="text-2xl font-bold text-slate-800 tracking-tight">Tambah Kriteria Baru</h2>
                ...
                <div class="bg-white border border-slate-100 rounded-[32px] p-10 shadow-sm relative">
                    ...
                    <div class="space-y-8">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nama_kriteria" value="{{ old('nama_kriteria') }}" required 
                                ...
                                placeholder="Misal: Barang Kebersihan Kelas">
                        </div>

                        <div class="space-y-2">
                            <label class="text-[11px] font-bold text-slate-400 uppercase ml-1">Bobot Penilaian (%)</label>
                            <div class="relative w-full">
                                <input type="number" name="bobot" value="{{ old('bobot') }}" min="1" max="100" required 
